#!/bin/bash
export PYTHONPATH=$PYTHONPATH:/home/william/Documents/workspace/magal/src/
export PYTHONPATH=$PYTHONPATH:/home/william/Documents/workspace/pystarlight/src/
cd /home/william/Documents/workspace/magal/src/

rm /net/data_astro/william/new_catalogs/BScat_32.hdf5

python  magal/io/starlight_hdf5convert.py -d DR7 -b BS -st /net/Starlight_SDSS/DR7/input/\
